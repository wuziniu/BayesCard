...
def gen_stats_old_schema(hdf_path):
    ...
    # posts
    schema.add_table(Table('posts', attributes=['Id', 'PostTypeId', 'AcceptedAnswerId', 'CreationDate',
                                                'Score', 'ViewCount', 'OwnerUserId', 'LasActivityDate',
    ...
    # tags
    schema.add_table(Table('tags', attributes=['Id', 'Count', 'ExcerptPostId', 'WikiPostId'],
